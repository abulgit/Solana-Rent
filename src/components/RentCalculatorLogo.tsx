...
export const RentCalculatorLogo: React.FC<{ onToggleInfo: () => void }> = ({ onToggleInfo }) => (
  <div className="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
    ...
    <svg
      ...
      <h1 className="text-gray-300 text-2xl">Rent Calculator</h1>
    </div>
    <button
      onClick={onToggleInfo}
      className="text-[#9945FF] hover:text-[#14F195] transition-colors"
      aria-label="Toggle rent information"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-6 w-6"
